...
const Logo = () => {
  return (
    <div className="flex flex-row  bg-white items-center text-center justify-between  bg-transaprent gap-1 " data-theme="cmyk">
<img
  src="src/assets/cesam.jpg"  // Mets le bon chemin ici
  alt="logocesam"
  width={24}
  height={24}
