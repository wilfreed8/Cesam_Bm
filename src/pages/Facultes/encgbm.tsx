...
export default function DocuFac() {
  ...
  return (
    <div className="p-4 md:p-10 space-y-6 w-screen ">
      <ToastContainer />
          ...
          <div className="dropdown mb-10  ">
            ...
            >
              ...
              <svg
                width="12px"
                height="12px"
                className="inline-block h-4 w-2 fill-current animate-bounce ml-1 "
