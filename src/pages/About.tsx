...
const AboutPage = () => {
  return (
    <section className="max-w-5xl mx-auto px-4 pt-25 space-y-10">
      <Meteors number={20}/>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold font-serif text-pretty text-green-600">Qui sommes-nous ?</h2>
        <p className="font-medium text-gray-700">
          La <strong className="text-primary font-bold">CESAM Beni Mellal</strong> est une section locale de la
      ...
      {/* Nos activités */}
      <div className="space-y-4">
        <h2 className="text-2xl font-bold  text-pretty text-green-600">Nos activités</h2>
        <ul className="list-disc list-inside space-y-2 text-gray-700 font-semibold">
